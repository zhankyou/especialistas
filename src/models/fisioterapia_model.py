...
class FormularioFisioterapia(db.Model):
    ...
    # 1. Datos Generales Estandarizados Universales
    ...
    nombre_fisioterapeuta = db.Column(db.String(200), nullable=False)
    ...
    # 2 al 8. Secciones JSONB (NoSQL Híbrido)
    tamizaje_motor = db.Column(JSONB, nullable=False, default=[])
    riesgo_caidas = db.Column(JSONB, nullable=False, default=[])
    barreras_arquitectonicas = db.Column(JSONB, nullable=False, default=[])
    riesgo_ergonomico = db.Column(JSONB, nullable=False, default=[])
    acciones_educacion = db.Column(JSONB, nullable=False, default={})
    canalizacion = db.Column(JSONB, nullable=False, default={})
    sintesis_evidencias = db.Column(JSONB, nullable=False, default={})
    ...
    firma_jefe = db.Column(db.Text, nullable=False)
    cc_jefe = db.Column(db.String(20), nullable=True, default='No registrado')
