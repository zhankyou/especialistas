...
class FormularioRespiratoria(db.Model):
    """Modelo estructurado para la Valoración de Terapia Respiratoria APS."""
    ...
    nombre_profesional = db.Column(db.String(200), nullable=False)
    ...
    # 2, 3, 4 y 5. Datos Estructurados Clínicos (JSONB)
    composicion_familiar = db.Column(JSONB, nullable=False)
    riesgos_intradomiciliarios = db.Column(JSONB, nullable=False)
    acciones_educacion = db.Column(JSONB, nullable=False)
    seguimiento_era = db.Column(JSONB, nullable=True)
