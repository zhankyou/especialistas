...
class FormularioRespiratoria(db.Model):
    ...
    sintomatologia = db.Column(db.JSON, nullable=True)
    plan_cuidado = db.Column(db.JSON, nullable=True)
    riesgos_intradomiciliarios = db.Column(db.JSON, nullable=True)
    ...
    def to_dict(self):
        sint_dict = self._deep_parse_json(self.sintomatologia, default_type=dict)
        plan_dict = self._deep_parse_json(self.plan_cuidado, default_type=dict)
        riesgos_dict = self._deep_parse_json(self.riesgos_intradomiciliarios, default_type=dict)
        ...
        return {
            ...
            "nombre_profesional": str(self.nombre_profesional or ""),
            ...
            "sintomatologia": sint_dict,
            "plan_cuidado": plan_dict,
            "riesgos_intradomiciliarios": riesgos_dict,
